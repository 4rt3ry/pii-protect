        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50 flex items-center justify-center p-6">
            <div className="bg-white rounded-3xl shadow-2xl p-12 max-w-md w-full text-center">
                ...
                <div className="bg-gradient-to-r from-violet-600 to-indigo-600 rounded-2xl py-10 px-8 mb-8">
                    <div className="text-4xl sm:text-6xl font-mono font-black text-white tracking-widest select-all">
                        {code}
                    </div>
                </div>

                <p className="text-2xl text-gray-700 mb-2">
                    Expires in <span className="text-2xl sm:text-3xl font-bold text-red-600"> {timeLeft} </span> s
                </p>
